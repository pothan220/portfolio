...
const STOP_WORDS = new Set([
  "a","an","the","is","are","was","were","be","been","have","has","do","does","did",
  "will","would","could","should","i","me","my","we","our","you","your","he","his",
  "she","her","it","its","they","them","what","which","who","this","that","and","but",
  "or","not","just","tell","please","want","know","like","can","get","give","show",
  "explain","any","some","all","most","much","at","by","for","in","of","on","to",
  "with","about"
]);
...
function buildSynMap(kb: KBEntry[]) {
    ...
    expanded.forEach((token) => {
      ...
      entry.tags.forEach((tag) => {
        tag.split(" ").forEach((tagToken) => {
          ...
          if (similarity > 0) score += similarity * idf;
        });
      });
    });
